    ...
    public class DLADbContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            optionsBuilder.UseSqlServer(
                //DESKTOP-P6ARS2G\SQLEXPRESS
                //@"Data Source=DESKTOP-P6ARS2G\SQLEXPRESS;Initial Catalog=BD_FinanceApp;Integrated Security=True"
            ...
            //"Data Source=(localdb)DESKTOP-P6ARS2G\\SQLEXPRESS;Initial Catalog=EADB;Integrated Security=True;Connect Timeout=30;Encrypt=True;Trust Server Certificate=False;Application Intent=ReadWrite;Multi Subnet Failover=False;Command Timeout=30"
            );
        }
